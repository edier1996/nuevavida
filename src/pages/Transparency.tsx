...
const Transparency = () => (
  <main className="min-h-screen bg-background">
    ...
    <article className="container mx-auto max-w-3xl px-4 py-16">
      <h1 className="text-3xl font-bold text-foreground">⚖️ Marco Legal y Ambiental</h1>
      ...
      <div className="mt-8 space-y-8 text-sm text-muted-foreground">
        ...
        <div>
          ...
          <p className="mt-3">♻️ El <strong>Programa de las Naciones Unidas para el Medio Ambiente</strong> promueve la economía circular y la gestión responsable de residuos, principios clave de Nueva Vida.</p>
        </div>
        ...
        <div>
          <p className="font-semibold text-foreground text-base">♻️ Principio Clave: Economía Circular</p>
        ...
        <div className="rounded-xl bg-primary/10 border border-primary/20 p-5">
          <p className="font-semibold text-foreground">⚖️ Conclusión Legal</p>
