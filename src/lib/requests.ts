...
const resolveApiBaseUrl = () => {
  const runtimeUrl =
    ...
    typeof (window as Window & { __API_CONFIG__?: Record<string, string> }).__API_CONFIG__?.VITE_ORDERS_API_BASE_URL === "string" &&
    (window as Window & { __API_CONFIG__?: Record<string, string> }).__API_CONFIG__!.VITE_ORDERS_API_BASE_URL !== "__VITE_ORDERS_API_BASE_URL__"
      ? (window as Window & { __API_CONFIG__?: Record<string, string> }).__API_CONFIG__!.VITE_ORDERS_API_BASE_URL
      : "";
